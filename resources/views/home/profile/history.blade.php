<div class="container my-4">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card">
        <div class="card-body">
          <a href="/profile?peserta_id={{request('peserta_id')}}" class="btn btn-info "><i class="fa fa-arrow-left"></i> Kembali</a>
          <h5><b>Riwayat Pemeriksaan {{$peserta->nama}}</b></h5>
            ...
            <table class="table table-striped table-bordered mt-2">
              ...
              @foreach ($peserta->pemeriksaan as $item)
                  <tr>
                    ...
                    <td>
                      <a href="history?peserta_id={{$peserta->id}}&imunisasi_id={{$item->imunisasi_id}}" class="btn btn-primary btn-sm"><i class="fa fa-sign-out-alt" ></i></a>
                    </td>
                  </tr>
              @endforeach
            </table>
